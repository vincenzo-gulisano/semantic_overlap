folder=data/output_files/joinwikipediaintraspe/
duration=120000
duration=120000
batch_size=1
...
rates=(2000 2000 2000 600 600 600 1600 700 300 300 200 100 2000 2000 2000 700 700 700)
impl_types=(SINGLEOUT SINGLEOUT)
exp_ids=(AHJ HHJ) 
rates=(200 100)
max_diff=15
